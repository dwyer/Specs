Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/dwyer/launchkit-ios"
  s.license          = 'Apache 2.0'
  s.author           = { "AppToolkit, Inc." => "admin@apptoolkit.io" }
  s.source           = { :git => "https://github.com/dwyer/launchkit-ios.git", :tag => s.version.to_s }
  ...
  s.subspec 'AppToolkit' do |launchkit|
